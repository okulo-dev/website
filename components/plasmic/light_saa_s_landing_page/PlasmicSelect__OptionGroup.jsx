...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: LAhUBBHpbeZo/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: IDgefGi3LA0o/render
      ...
      >
        {renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__nX9)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__lP2R)}
              />
            </React.Fragment>
          ),
