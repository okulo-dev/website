...
import sty from "./PlasmicButton.module.css"; // plasmic-import: 1njYuUl2Bkl4/css
import ChevronRightIcon from "./icons/PlasmicIcon__ChevronRight"; // plasmic-import: LsAEZXbbm3PS/icon
    ...
    >
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <svg
                className={classNames(projectcss.all, sty.svg__q7PiU)}
                role={"img"}
              />
            ),
      ...
      {(
        ...
        ? renderPlasmicSlot({
            defaultContents: (
              <ChevronRightIcon
                className={classNames(projectcss.all, sty.svg__vtPn6)}
                role={"img"}
              />
            ),
